...
export function Footer() {
  return <footer className="border-t border-ivory/10 bg-smoke">
    <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 md:grid-cols-5 lg:px-8">
      ...
      <div><h3 className="text-sm uppercase tracking-[0.25em] text-champagne">More</h3><div className="mt-4 flex flex-col gap-3 text-ivory/70"><Link href="/collaboration">Collaboration</Link><Link href="/refer-a-friend">Refer a Friend</Link><Link href="/about">About</Link></div></div>
    </div>
