    ...
    const result = await prisma.$transaction(async (tx: any) => {
      ...
      const intake = await tx.sessionIntake.create({
        data: {
          ...
          schemaVersion: '1.0',
          desiredFeelings: (validatedIntake.desiredFeelings as string[]) ?? null,
          visualStyles: (validatedIntake.visualStyles as string[]) ?? null,
          posingStyles: (validatedIntake.posingStyles as string[]) ?? null,
          posingIntensity: (validatedIntake.posingIntensity as string) || null,
          coveragePreferences: (validatedIntake.coveragePreferences as string[]) ?? null,
          ...
          musicGenres: (validatedIntake.musicGenres as string[]) ?? null,
          ...
          wardrobePlans: (validatedIntake.wardrobePlans as string[]) ?? null,
