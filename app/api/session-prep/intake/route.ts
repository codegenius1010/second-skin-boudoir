    ...
    const result = await prisma.$transaction(async (tx: any) => {
      ...
      const intake = await tx.sessionIntake.create({
        data: {
          ...
          schemaVersion: '1.0',
          desiredFeelings: (validatedIntake.desiredFeelings as string[])?.length > 0 ? validatedIntake.desiredFeelings : null,
          visualStyles: (validatedIntake.visualStyles as string[])?.length > 0 ? validatedIntake.visualStyles : null,
          posingStyles: (validatedIntake.posingStyles as string[])?.length > 0 ? validatedIntake.posingStyles : null,
          posingIntensity: (validatedIntake.posingIntensity as string) || null,
          coveragePreferences: (validatedIntake.coveragePreferences as string[])?.length > 0 ? validatedIntake.coveragePreferences : null,
          ...
          musicGenres: (validatedIntake.musicGenres as string[])?.length > 0 ? validatedIntake.musicGenres : null,
          ...
          wardrobePlans: (validatedIntake.wardrobePlans as string[])?.length > 0 ? validatedIntake.wardrobePlans : null,
