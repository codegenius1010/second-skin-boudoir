    ...
    const result = await prisma.$transaction(async (tx: any) => {
      ...
      const intake = await tx.sessionIntake.create({
        data: {
          ...
          schemaVersion: '1.0',
          desiredFeelings: (validatedIntake.desiredFeelings as string[]) || [],
          visualStyles: (validatedIntake.visualStyles as string[]) || [],
          posingStyles: (validatedIntake.posingStyles as string[]) || [],
          posingIntensity: (validatedIntake.posingIntensity as string) || null,
          coveragePreferences: (validatedIntake.coveragePreferences as string[]) || [],
          ...
          musicGenres: (validatedIntake.musicGenres as string[]) || [],
          ...
          wardrobePlans: (validatedIntake.wardrobePlans as string[]) || [],
